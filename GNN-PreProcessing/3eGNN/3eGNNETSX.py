                        ...
                        for j in range(n):
                            ...
                            for i in range(363):
                                if i == 0:
                                    ...
                                    if Y1 == Y2 and Y1==Y3 and X1==X2 and X1==X3:
                                            C.append(Y1)
                                            M.append(X1)
                                            L.append(0)
                                            E.append(1)
                            ...
                            MNN["y"] = 2
                            torch.save(MNN,'/Directory/GNN/ETSX/3e{}.pt'.format(nc))
                            with zipfile.ZipFile('/Directory/GNN/ETSX/3e{}.zip'.format(nc), 'w', zipfile.ZIP_DEFLATED) as f:
                                    f.write('/Directory/GNN/ETSX/3e{}.pt'.format(nc))
                            os.remove('/Directory/GNN/ETSX/3e{}.pt'.format(nc))
                    elif NRR <n:
