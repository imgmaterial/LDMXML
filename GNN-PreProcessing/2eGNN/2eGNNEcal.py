        ...
        if nE<nc:
            ...
            if nc == 0:
                for j in range(n):
                    ...
                    MNN["y"] = 1
                    torch.save(MNN,'/Directory/GNN/Ecal/2e{}.pt'.format(nc))
                    with zipfile.ZipFile('/Directory/GNN/Ecal/2e{}.zip'.format(nc), 'w', zipfile.ZIP_DEFLATED) as f:
                            f.write('/Directory/GNN/Ecal/2e{}.pt'.format(nc))
                    os.remove('/Directory/GNN/Ecal/2e{}.pt'.format(nc))
            elif NRR <n:
