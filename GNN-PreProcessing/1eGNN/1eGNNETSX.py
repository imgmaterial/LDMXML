                ...
                if nTS<nc:
                    ...
                    if nc==0:
                        for j in range(n):
                            ...
                            for i in range(156):
                                if i == 0:
                                    if pd.isna(chunkTS['{}'.format('y')][j]) == False:#Adds the extra 'x' coordinate 
                                        C.append((int(chunkTS['{}'.format('y')][j])))
                                        M.append(int(chunkTS['{}'.format('x')][j]))
                                        L.append(0)
                                        E.append(1)
                                else:
                            ...
                            MNN["y"] = 0
                            torch.save(MNN,'/Directory/GNN/ETSX/1e{}.pt'.format(nc))
                            with zipfile.ZipFile('/Directory/GNN/ETSX/1e{}.zip'.format(nc), 'w', zipfile.ZIP_DEFLATED) as f:
                                    f.write('/Directory/GNN/ETSX/1e{}.pt'.format(nc))
                            os.remove('/Directory/GNN/ETSX/1e{}.pt'.format(nc))
                    elif NRR <n:
