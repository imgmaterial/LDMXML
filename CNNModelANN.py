...
#Model Used for the Ecal and Trigger Scintillator Dataset

model = Sequential()


model.add(layers.Conv3D(64,(2,2,2),activation='relu',input_shape=(35,8,450,1)))
...
model.add(layers.Dense(128,'tanh',kernel_regularizer=regularizers.L1(l1=1e-3)))

model.add(Dropout(0.6))

model.add(layers.Dense(NumberClasses,'softmax'))
...
#Loads the model for extra work 
