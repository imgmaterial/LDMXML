...
train_dir = '/projects/hep/fs9/shared/ldmx/users/pa8701os/LDMXML/8mil_processing/RNNETSX'#This is wherever you have saved the data that was produced after preprocessing that you want to feed to your network  

subdirs, dirs, files = os.walk('/projects/hep/fs9/shared/ldmx/users/pa8701os/LDMXML/8mil_processing/RNNETSX').__next__()#This will walk around the directory and pick out any files it discovers there 
...
lstm_3 = keras.layers.GRU(128, activation='tanh',recurrent_dropout=0)(lstm_e)
...
checkpoint = ModelCheckpoint(filepath='Checkpoints/RNNETSX8mil1ep',save_best_only=True, monitor='accuracy', mode='max', save_freq=1000, verbose=1) 
...
model.save("Models/RNNETSX8mil1")#Saves the model and can resume training after stopping 
